...
interface Store {
    ...
    appendAgent(chatId: string, content: Content$1, opts?: {
        replyTo?: string;
    }): string;
    appendUser(chatId: string, content: Content$1, opts?: {
        attachmentPath?: string;
    }): string;
    ...
    pushUserInput(chatId: string, content: Content$1): void;
...
export { type ChatState, type CommandDef, type HoveredPreview, type LogEntry, type PendingAttachment, type Role, type Snapshot, type Store, type TuichatClient, tuichat };
